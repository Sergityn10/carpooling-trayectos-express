...
| [trayectos.md](./trayectos.md)                                 | Trayectos                 | `/api/trayecto`, `/api/admin/trayectos` | CRUD de trayectos, búsqueda, estados, recorridos, recogidas, administración (admin)                              |
| [admin.md](./admin.md)                                         | Administración            | `/api/admin`                            | CRUD admin de reservas, comentarios, pagos, recorridos, eventos, tramos, ubicaciones, rutas frecuentes, InfoCAEs |
